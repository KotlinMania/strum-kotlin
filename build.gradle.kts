...
kotlin {
    ...
    val xcf = XCFramework("Strum")

    macosArm64 {
        binaries.framework { baseName = "Strum"; xcf.add(this) }
    }
    iosArm64 {
        binaries.framework {
            baseName = "Strum"
    ...
    swiftExport {
        moduleName = "Strum"
        flattenPackage = "io.github.kotlinmania.strum"
    }

    android {
        namespace = "io.github.kotlinmania.strum"
        compileSdk = 34
        minSdk = 24
...
mavenPublishing {
    ...
    coordinates(group.toString(), "strum-kotlin", version.toString())

    pom {
        name.set("strum-kotlin")
        description.set("Kotlin Multiplatform port of Peternator7/strum - Helpful macros for working with enums and strings")
        inceptionYear.set("2026")
        url.set("https://github.com/KotlinMania/strum-kotlin")
        ...
        scm {
            url.set("https://github.com/KotlinMania/strum-kotlin")
            connection.set("scm:git:git://github.com/KotlinMania/strum-kotlin.git")
...
val fullTargetBuildTasks = listOf(
    ...
    "assembleStrumReleaseXCFramework",
    "assembleDebugIosFatFrameworkForStrumXCFramework",
    "assembleReleaseIosFatFrameworkForStrumXCFramework",
    "assembleDebugIosSimulatorFatFrameworkForStrumXCFramework",
    "assembleReleaseIosSimulatorFatFrameworkForStrumXCFramework",
    "assembleDebugMacosFatFrameworkForStrumXCFramework",
    "assembleReleaseMacosFatFrameworkForStrumXCFramework",
    "assembleDebugTvosFatFrameworkForStrumXCFramework",
    "assembleReleaseTvosFatFrameworkForStrumXCFramework",
    "assembleDebugTvosSimulatorFatFrameworkForStrumXCFramework",
    "assembleReleaseTvosSimulatorFatFrameworkForStrumXCFramework",
    "assembleDebugWatchosFatFrameworkForStrumXCFramework",
    "assembleReleaseWatchosFatFrameworkForStrumXCFramework",
    "assembleDebugWatchosSimulatorFatFrameworkForStrumXCFramework",
    "assembleReleaseWatchosSimulatorFatFrameworkForStrumXCFramework",
