...
// of the pipeline:
//
//   1. `embedSwiftExportForXcode` produced `Strum.swiftmodule/`
...
//      `import Strum` above would fail at compile time.
//
//   2. The static archive `libStrum.a` (produced by the
...
//      architecture arm64".
//
//   3. The Kotlin `swiftExport { moduleName = "Strum" }` and
//      `flattenPackage = "io.github.kotlinmania.strum"` configuration in
...
final class StrumExportTests: XCTestCase {
    func testSwiftModuleLoads() throws {
        XCTAssertTrue(true, "Strum swift module imported cleanly")
    }
}
