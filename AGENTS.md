...
This file is the quick-reference operating contract for strum-kotlin. The longer
...
strum-kotlin is a Kotlin Multiplatform port of the upstream Rust crate or module
[`strum`](https://crates.io/crates/strum). Upstream Rust is the behavioral oracle while the
